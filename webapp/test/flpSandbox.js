		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#displaybankdetailsofemployeemybankdetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"displaybankdetailsofemployeemybankdetails-display": {
								"semanticObject": "displaybankdetailsofemployeemybankdetails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=displaybankdetailsofemployee.mybankdetails",
									"url": sap.ui.require.toUrl("displaybankdetailsofemployee/mybankdetails")
								}
							}
						}
					}
